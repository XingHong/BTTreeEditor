...
{
  [Newtonsoft.Json.JsonProperty("IsAvailableFalling")]
  public bool IsAvailableFalling { get; set; }
  [Newtonsoft.Json.JsonProperty("LightballRatio")]
  public int LightballRatio { get; set; }
  [Newtonsoft.Json.JsonProperty("TntRatio")]
  public int TntRatio { get; set; }
  [Newtonsoft.Json.JsonProperty("RocketHorizontalRatio")]
  public int RocketHorizontalRatio { get; set; }
  [Newtonsoft.Json.JsonProperty("RocketVerticalRatio")]
  public int RocketVerticalRatio { get; set; }
  [Newtonsoft.Json.JsonProperty("PropellerRatio")]
