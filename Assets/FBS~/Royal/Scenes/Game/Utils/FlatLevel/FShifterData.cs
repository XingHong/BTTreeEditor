...
{
  [Newtonsoft.Json.JsonProperty("ItemCells")]
  public List<Royal.Scenes.Game.Utils.FlatLevel.FPointT> ItemCells { get; set; }
  [Newtonsoft.Json.JsonProperty("StartMasterIndex")]
  public int StartMasterIndex { get; set; }
  [Newtonsoft.Json.JsonProperty("EndMasterIndex")]
  ...
  [Newtonsoft.Json.JsonProperty("TurnPoint")]
