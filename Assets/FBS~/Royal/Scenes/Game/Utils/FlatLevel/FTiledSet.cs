...
public class FTiledSetT
{
  ...
  [Newtonsoft.Json.JsonProperty("CanFall")]
  public bool CanFall { get; set; }
  [Newtonsoft.Json.JsonProperty("CreateRatio")]
  public int CreateRatio { get; set; }
  [Newtonsoft.Json.JsonProperty("TargetColumns")]
  public List<int> TargetColumns { get; set; }
  [Newtonsoft.Json.JsonProperty("BirdMax")]
  public int BirdMax { get; set; }
  [Newtonsoft.Json.JsonProperty("FrogMax")]
  public int FrogMax { get; set; }
  [Newtonsoft.Json.JsonProperty("TargetFills")]
  public List<int> TargetFills { get; set; }
  [Newtonsoft.Json.JsonProperty("TargetFillRatios")]
  public List<int> TargetFillRatios { get; set; }
  [Newtonsoft.Json.JsonProperty("MaxItemCounts")]
