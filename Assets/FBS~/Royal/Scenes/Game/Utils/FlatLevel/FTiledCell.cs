...
{
  [Newtonsoft.Json.JsonProperty("FillType")]
  public int FillType { get; set; }
  [Newtonsoft.Json.JsonProperty("IsPredefined")]
  public bool IsPredefined { get; set; }
  [Newtonsoft.Json.JsonProperty("Grass")]
  public int Grass { get; set; }
  [Newtonsoft.Json.JsonProperty("Honey")]
  public int Honey { get; set; }
  [Newtonsoft.Json.JsonProperty("Curtain")]
  public int Curtain { get; set; }
  [Newtonsoft.Json.JsonProperty("Chain")]
  public int Chain { get; set; }
  [Newtonsoft.Json.JsonProperty("Roof")]
  public int Roof { get; set; }
  [Newtonsoft.Json.JsonProperty("Jelly")]
  public int Jelly { get; set; }
  [Newtonsoft.Json.JsonProperty("Treasuremap")]
  public int Treasuremap { get; set; }
  [Newtonsoft.Json.JsonProperty("Ceramic")]
  public int Ceramic { get; set; }
  [Newtonsoft.Json.JsonProperty("MushroomSoil")]
  public int MushroomSoil { get; set; }
  [Newtonsoft.Json.JsonProperty("Blinds")]
  public int Blinds { get; set; }
  [Newtonsoft.Json.JsonProperty("WaterSoil")]
