...
public struct Monster : IFlatbufferObject
{
  ...
  public MyGame.Sample.Vec3? Path(int j) { int o = __p.__offset(20); return o != 0 ? (MyGame.Sample.Vec3?)(new MyGame.Sample.Vec3()).__assign(__p.__vector(o) + j * 12, __p.bb) : null; }
  public int PathLength { get { int o = __p.__offset(20); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  public static void AddPath(FlatBufferBuilder builder, VectorOffset pathOffset) { builder.AddOffset(8, pathOffset.Value, 0); }
...
static public class MonsterVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 20 /*Path*/, 12 /*MyGame.Sample.Vec3*/, false)
